    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const motorbike = new Motorbike(
          ...
          parseInt(answers.weight),
          parseInt(answers.topSpeed),
          [new Wheel(20, 'Goodyear'), new Wheel(20, 'Goodyear')],
    ...
    inquirer
      .prompt([
        {
          ...
          choices: [
            ...
            'Turn left',
            'Reverse',
            'Tow vehicle', // adding Truck specific
            'Perform wheelie', // adding  Motorbike specific
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          // find if its a truck and tow it
          ...
          // find if its mortobke can make weelies 
          ...
          if(motorbike){
            ...
            console.log("this action is only for motorbike")
          }
        }
